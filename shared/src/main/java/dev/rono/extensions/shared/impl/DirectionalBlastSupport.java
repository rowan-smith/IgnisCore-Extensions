 ...
 */
final class DirectionalBlastSupport {
    private DirectionalBlastSupport() {
    }

    static float resolveYaw(IgnisStrategyContext context, Object triggerContext, IgnisLocation fallback) {
    ...
    static void forwardBlast(IgnisWorld world,
    ...
    static void coneBlast(IgnisWorld world,
                                IgnisLocation origin,
                                float yaw,
                                double range,
                                double coneAngle,

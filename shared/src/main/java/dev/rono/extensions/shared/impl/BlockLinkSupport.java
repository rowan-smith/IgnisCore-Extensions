...
final class BlockLinkSupport {
    ...
    static void link(IgnisNbtService nbt, IgnisItem item, String blockTypeId, IgnisLocation location) {
        if (nbt == null) {
            return;
        }
    ...
    static boolean hasLink(IgnisNbtService nbt, IgnisItem item) {
        if (nbt == null) {
            return false;
        }
    ...
    static IgnisLocation readLocation(IgnisNbtService nbt, IgnisItem item) {
    ...
    static String readType(IgnisNbtService nbt, IgnisItem item) {
        if (nbt == null) {
            return "";
        }
    ...
    static boolean withinRange(IgnisPlayer player, IgnisLocation target, double maxRange) {
        if (target == null) {
            return false;
        }
    ...
    static void clear(IgnisNbtService nbt, IgnisItem item) {
        if (nbt == null) {
            return;
        }

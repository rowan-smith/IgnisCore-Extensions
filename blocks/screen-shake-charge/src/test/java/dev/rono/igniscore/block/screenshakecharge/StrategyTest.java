...
class StrategyTest {
    private static final String EXTENSION_ID = "screen-shake-charge";
    ...
    void manifestMatchesExtensionId() {
        ...
        assertEquals("dev.rono.igniscore.block.screenshakecharge.Strategy", manifest.getStrategyClass());
    }
    @Test

package dev.rono.igniscore.item.unlabeledpotion;
...
class BehaviorTest {
    ...
    void useDoesNotThrow() {
        ...
        ItemDefinition definition = ExtensionTestSupport.loadItemDefinition(
                BehaviorTest.class, "unlabeled-potion", 20001);
        Strategy strategy = TestEventBus.activate(() -> new Strategy(ctx.context()), "unlabeled-potion");

...
final class CentrifugeTntBehavior {
    ...
    void onTick(RuntimeBlockInstance instance) {
        ...
        int elapsed = ExtensionShared.explosion().elapsedFuseTicks(instance, 70);
        ExtensionShared.physics().spiralKnockback(worldAt(center), center, radius, strength, elapsed);
    ...
    void onTrigger(RuntimeBlockInstance instance, Object triggerContext) {
        ...
        ExtensionShared.physics().spiralKnockback(world, loc, radius, 1.4, instance.getTicksLeft());

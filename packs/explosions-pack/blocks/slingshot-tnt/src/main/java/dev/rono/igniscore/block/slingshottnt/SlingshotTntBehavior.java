...
final class SlingshotTntBehavior {
    ...
    void onTrigger(RuntimeBlockInstance instance, Object triggerContext) {
        ...
        float yaw = ExtensionShared.blasts().resolveYaw(context, triggerContext, instance.getLocation());
        ...
        ExtensionShared.blasts().forwardBlast(world, loc, yaw, steps, stepDistance, power, false);
    }
